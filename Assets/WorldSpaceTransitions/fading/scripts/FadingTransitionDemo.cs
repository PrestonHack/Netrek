...
namespace WorldSpaceTransitions
{
    public class FadingTransitionDemo : MonoBehaviour
    {
        ...
        public void ModifyMaterials(int i)
        {
            ...
            else if (GraphicsSettings.renderPipelineAsset.name == "LightweightRenderPipelineAsset")
            {
                if (s == "transparent one sided") shader = Shader.Find("Lightweight Render Pipeline/Fading/Transparent");
                if (s == "dissolve") shader = Shader.Find("Lightweight Render Pipeline/Fading/DissolveDouble");
                if (s == "dissolve double sided") shader = Shader.Find("Lightweight Render Pipeline/Fading/DissolveDouble");
                if (s == "screenspace dissolve") shader = Shader.Find("Lightweight Render Pipeline/Fading/ScreenspaceDissolveDouble");
                if (s == "screensp. diss. double") shader = Shader.Find("Lightweight Render Pipeline/Fading/ScreenspaceDissolveDouble");
                if (s == "dissolve glow 1/s") shader = Shader.Find("Lightweight Render Pipeline/Fading/DissolveGlowDouble");
                if (s == "dissolve glow 2/s") shader = Shader.Find("Lightweight Render Pipeline/Fading/DissolveGlowDouble");
                if (s == "screensp. diss. glow 1/s") shader = Shader.Find("Lightweight Render Pipeline/Fading/ScreenspaceDissolveGlowDouble");
                if (s == "screensp. diss. glow 2/s") shader = Shader.Find("Lightweight Render Pipeline/Fading/ScreenspaceDissolveGlowDouble");
